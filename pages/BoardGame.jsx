...
const BoardGame = (props) => {
  ...
  let [hasToPlay, setHasToPlay] = useState(props.playerz[0].uid === null ? "" : props.playerz[0].uid);
  let [contractor, setContractor] = useState(props.playerz[0].uid === null ? "" : props.playerz[0].uid);
